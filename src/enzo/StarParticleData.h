...
SPEXTERN float StarFeedbackMomentumMultiplier;
SPEXTERN int StarFeedbackCapVelocityKick;
SPEXTERN float StarFeedbackSNePerTimestepLimit;
SPEXTERN int StarFeedbackStochasticSNe;
SPEXTERN int StarFeedbackPreSNFeedback;
SPEXTERN int StarFeedbackPreSNMomentum;
SPEXTERN char* StarFeedbackPreSNFilename;
...
SPEXTERN int StarFeedbackSphere;
SPEXTERN float StarFeedbackSNIIRadius;
SPEXTERN float StarFeedbackSNIaRadius;
SPEXTERN float StarFeedbackPreSNRadius;
